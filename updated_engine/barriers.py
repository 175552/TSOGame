			...
			if(verb == 'check'):
				...
				for item in inventory:
					if(str(item).title == 'flame sword'):
						passable = True
						return [True, "The guardian has verified that you have the flame sword. You may pass.", inventory]
					else:
						self.timesTried += 1
						if(self.timesTried == 2):
							return [True, "The guardian swings a might fist at you and connects with your ribs. You hear a cracking sound and black out.", inventory]
						else:
